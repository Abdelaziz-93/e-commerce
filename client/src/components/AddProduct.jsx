...
export default function AddProduct() {
    ...
    function addProduct(e){
      ...
      axios.post(`${window.location.origin}/product/newProduct`,formData,{
        headers: {
                        ...
                        <div class="col-xl-8 m-auto col-lg-8">
                            <div class="card mb-4 shadow-sm">
                                <div class="card-body">
                                    ...
                                    </div><div class="mb-4"><label class="form-label">Image</label>
                           
                                         <input class="form-control mt-3" onChange={changeImage} type="file" />
                                    </div>
                                    <button  className="btn mt-4 btn-dark w-100">Add Product</button>
                                    </form>
                                </div>
                            </div>
                        </div>
