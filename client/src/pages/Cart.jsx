...
export default function Cart() {
  ...
  function addOrder() {
    ...
    axios.post(`https://e-commerce-server-dnm8.onrender.com/order/newOrder`, {
                  ...
                  data.map((value, key) => {
                    return <div className='order-card d-flex my-5' key={key}>
                      <div className='float-start order-img'>
                        <img src={`https://e-commerce-server-dnm8.onrender.com/uploads/${value.product.image[0]}`} className='imgcart w-100' alt="" />
                      </div>
